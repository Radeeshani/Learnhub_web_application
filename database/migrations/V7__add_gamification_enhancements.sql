-- Migration V7: Add Enhanced Gamification Features
...
ADD COLUMN current_level INT DEFAULT 1 NOT NULL,
ADD COLUMN experience_points INT DEFAULT 0 NOT NULL;
...
INSERT INTO user_levels (name, level_number, points_required, color, special_privileges, level_up_animation) VALUES
...
INSERT INTO challenges (title, description, type, points_reward, start_date, end_date, criteria, reward_icon) VALUES
