-- Corrected Database Setup Script for Homework Application
-- This script uses proper BCrypt password hashes generated by the application
...
('Admin', 'User', 'admin@homework.com', '$2a$10$KkzKhBfYVCxAaJ2AefUKW.gYMvciJf1WbDNzph16Zmsavbfq2he5u', 'ADMIN', '+1234567890');
...
('John', 'Smith', 'teacher@homework.com', '$2a$10$w.0jZMbA.oMkvBzwIn/uF.G2XNdCbX1nxoiZihwb7mH4esCzDGU96', 'TEACHER', '+1234567891', 'Mathematics');
...
('Emma', 'Johnson', 'student@homework.com', '$2a$10$m2rtbZEA4xNhlViqV2WR4.W00TgI4EJ.m7Emjndx5PcJe4mIuoP0e', 'STUDENT', '+1234567892', '3rd Grade', 'STU001');
...
('Michael', 'Johnson', 'parent@homework.com', '$2a$10$u96PnR0aC2cBBfYVzRp79uiZoOx8WRhdxC1.SZIR3alwxHyXWw6LS', 'PARENT', '+1234567893', 3);
